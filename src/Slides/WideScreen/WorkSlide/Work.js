...
class Work extends Component {
  constructor(props) {
    ...
    this.workDetails = [
      ...
      {
        number: '01',
        projectName: 'Car Rental App',
        projectDesc: 'car renting service application provide car renting agancies to share their cars online  ',
        projectType: 'Android & IOS mobile Application',
        roles: ['Flutter Development ', 'UI Designer'],
      },
      {
        number: '02',
